...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-xs-4 col-sm-4" >
			<img src="img/CloudIQ.png" class="img-responsive" alt="logo" width="600">
		</div>
		<div class="col-md-8 col-xs-8 col-sm-8 centre" >
			</br>
			</br>
			</br>
			<h2> Simple et rapide
	...
	<div class="row">
		<div class="col-md-8 col-xs-8 col-sm-8" >
			...
			<h2> Le cloud en toute simplicité
			</h2>
			<p>
			</p>
		</div>
		<div class="col-md-4 col-xs-4 col-sm-4 centre" >
			<img src="img/CloudIQ.png" class="img-responsive" alt="logo" width="600">
